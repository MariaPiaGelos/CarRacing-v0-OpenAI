...
class Agent():
    ...
    # buffer_capacity, batch_size = 2000, 512
...
if __name__ == "__main__":
    ...
    for i_ep in range(100000):
        ...
        if i_ep % args.log_interval == 0:
            ...
            diff = ((actual_time - initial_time) / 60).__round__()
            print('Ep {}\tLast score: {:.2f}\tMoving average score: {:.2f}\tTime elapsed: {:.2f}'.format(i_ep, score, running_score, diff))
            agent.save_param()
